...
describe('top spots', function () {
  ...
  xit('should show a list of topspots as bootstrap wells', () =>
    nightmare
    .goto(url)
    .wait('div.well')
  ...
  xit('should show topspot name in each bootstrap well using a <h4> element.', () =>
    nightmare
    .goto(url)
    .wait('div.well')
  ...
  xit('should show topspot description in each bootstrap well using a <p> element.', () =>
    nightmare
    .goto(url)
    .wait('div.well')
  ...
  xit('should show a link in each bootstrap well using an <a> element styled as a bootstrap button.', () =>
    nightmare
    .goto(url)
    .wait('div.well')
